...
public class TypeCheckerTest
{
    ...
    {
        String str = 
                "public void foo() { int i; return i; }";
        assertFalse(typeCheck("MethodDeclaration", str));
    }
    ...
    {
        String str = 
                "class Foo { public Foo bar() { return this;} }";
        assertTrue(typeCheck("ClassDeclaration", str));
    }
    ...
    {
        String str = 
                "public int foo() { int[] i; i = new int[10]; i [1] = 1; return i[1]; }";
        assertTrue(typeCheck("MethodDeclaration", str));
    }
    ...
    {
        String str = 
                "public int foo() { int[] i; i = new int[10]; i [true] = 1; return i[1]; }";
        assertFalse(typeCheck("MethodDeclaration", str));
    }
    ...
    {
        String str = 
                "public int foo() { int[] i; i = new int[10]; i [1] = false; return i[1]; }";
        assertFalse(typeCheck("MethodDeclaration", str));
    }
    ...
    {
        String str = 
                "public int foo() { int[] i; i = true; i [1] = false; return i[1]; }";
        assertFalse(typeCheck("MethodDeclaration", str));
    }
    ...
    {
        String str = 
                "public int foo() { int i; if (true) i = 1;  else i = 2; return i; }";
        assertTrue(typeCheck("MethodDeclaration", str));
    }
    ...
    {
        String str = 
                "public int foo() { int i; if (1) i = 1;  else i = 2; return i; }";
        assertFalse(typeCheck("MethodDeclaration", str));
    }
    ...
    {
        String str = 
                "public int foo() { int i; i = 0; while (10 > i) { i = i + 1; } return i; }";
        assertTrue(typeCheck("MethodDeclaration", str));
    }    
    ...
    {
        String str = 
                "public int foo2() { int i; i = 0; while (i) { i = i + 1; } return i; }";
        assertFalse(typeCheck("MethodDeclaration", str));
    }    
